...
COV=0.7
ID=0.7
while getopts ':a:n:m:c:l:o:' args; do
  case "$args" in
...
echo "Splitting ORFs into separate files"
clu2fasta.py -clu ${OUT}/clu.tsv -outdir ${OUT} -prots ${AA}
echo "Performing dN/dS analysis with Codeml"
echo "This file is automatically generated during the ParaHunter run to fool codeml. Please feel free to delete" > tmp.trees
parahunter-dnds.py -out ${OUT} -clu ${OUT}/clu.tsv -aa ${AA} -nuc ${NUC} -ctl ${CTL}
